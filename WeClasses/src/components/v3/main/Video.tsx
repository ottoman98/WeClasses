      ...
      <section className="bg-gray-100 dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-2xl font-semibold text-gray-700 capitalize lg:text-3xl dark:text-white">
            ...
            <span className="text-light-blue">WeClasses </span>
            Content
          </h1>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2">
            <div className="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
              <div className="md:flex md:items-start md:-mx-4">
                <span className="inline-block p-2 text-light-blue bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                  <svg
