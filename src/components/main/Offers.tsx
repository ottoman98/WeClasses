      ...
      <div className="flex flex-col md:flex-row gap-5 md:gap-10">
        <div className="flex md:flex-col gap-5 items-center">
          ...
          <div className="flex flex-col gap-1 w-1/2">
            <strong className="text-blue-900 md:text-center  inline-block w-full    text-base md:text-lg">
              {translation.main.offer.content[0].title}
            </strong>
            <p className="text-justify">
              {translation.main.offer.content[0].body}
            </p>
            <Link className="text-center text-light-blue font-bold " to="/">
              <div className="flex flex-row items-center">
                <Link to="/classes">
                  {" "}
                  {translation.main.offer.content[0].link}
                </Link>
                <FcNext />
              </div>
            </Link>
        ...
        <div className="flex flex-row-reverse md:flex-col gap-5 items-center">
          ...
          <div className="w-1/2 flex flex-col gap-1">
            <strong className="text-blue-900 md:text-center  inline-block w-full    text-base md:text-lg">
              {translation.main.offer.content[1].title}
            </strong>
            <p className="text-justify">
              {translation.main.offer.content[1].body}
            </p>
            <Link className="text-center text-light-blue font-bold " to="/">
              <div className="flex flex-row items-center">
                <Link to="/classes">
                  {translation.main.offer.content[1].link}
                </Link>
                <FcNext />
              </div>
            </Link>
        ...
        <div className="flex md:flex-col gap-5 items-center">
          ...
          <div className="w-1/2 flex flex-col gap-1">
            <strong className="text-blue-900 md:text-center  inline-block w-full    text-base md:text-lg">
              {translation.main.offer.content[2].title}
            </strong>
            <p className="text-justify">
              {translation.main.offer.content[2].body}
            </p>
            <Link className="text-center text-light-blue font-bold " to="/">
              <div className="flex flex-row items-center">
                <Link to="/classes">
                  {" "}
                  {translation.main.offer.content[2].link}
                </Link>
                <FcNext />
              </div>
            </Link>
